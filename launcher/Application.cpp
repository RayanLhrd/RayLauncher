...
bool Application::createSetupWizard()
{
    ...
    if (wizardRequired) {
        ...
        // RayLauncher: the CurseForge API key wizard page is intentionally skipped — users just install
        // our own modpacks, they never paste a CurseForge key themselves.
