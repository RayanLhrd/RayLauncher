...
class Config {
   public:
    ...
    /**
     * URL to fetch the RayLauncher modpack index JSON from.
     * The JSON lists the modpacks the user can install in one click from the "Mes Modpacks" dialog.
     */
    QString RAYLAUNCHER_MODPACK_INDEX_URL;
